...
PARAM$finalmodel$learning_rate <- 0.177527457129521
PARAM$finalmodel$feature_fraction <- 0.743803373624832
PARAM$finalmodel$min_data_in_leaf <- 180
PARAM$finalmodel$num_leaves <- 942

PARAM$finalmodel$envios <- 5002
PARAM$finalmodel$max_depth <- 10
PARAM$finalmodel$bagging_fraction <- 0.845836774448049
PARAM$finalmodel$bagging_freq <-	3
PARAM$finalmodel$lambda_l1	<- 5.1972336543522
PARAM$finalmodel$lambda_l2  <-0.368855542071695
PARAM$finalmodel$min_gain_to_split <- 1.62879478881903
PARAM$finalmodel$max_bin <- 118
