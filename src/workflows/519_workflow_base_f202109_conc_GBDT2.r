...
HT_tuning_base <- function( pinputexps, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    max_bin = 50L, ### 31L, # lo debo dejar fijo, no participa de la BO
    ...
    num_leaves = c( 900L, 2048L,  "integer" ), ##c( 8L, 2048L,  "integer" ),
    min_data_in_leaf = c( 500L, 2000L, "integer" ) ##c( 20L, 2000L, "integer" )
  )
